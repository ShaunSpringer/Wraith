...
(function() {
  ...
  this.Wraith.RepeatingView = (function(_super) {
    ...
    RepeatingView.prototype.createView = function(model) {
      ...
      return this.$parent.append(this.Template.render(model));
    };
  ...
  this.Wraith.Controller = (function(_super) {
    ...
    Controller.prototype.registerView = function($view) {
      var binding, maps, repeating, target_model, template, textbox, view, _base, _ref, _ref1;
      ...
      if ((_ref1 = (_base = this.bindings)[target_model]) == null) {
        _base[target_model] = [];
      }
    ...
    Controller.prototype.bindViews = function(name, model) {
      var binding, bindings, map, mapping, view, _i, _len;
