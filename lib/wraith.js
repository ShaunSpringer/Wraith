...
(function() {
  ...
  this.Wraith.Base = (function() {
    function Base() {
      ...
      this.bind = __bind(this.bind, this);      this.listeners = {};
    }
  ...
  this.Wraith.View = (function(_super) {
    ...
    function View($el, template) {
      ...
      if (!this.$el) {
        throw new Error('Element is required by View');
      }
      if (!this.template) {
        throw new Error('Template is required by View');
      }
    ...
    View.prototype.updateView = function(model) {
      ...
      return this.bindEvents($view, model);
    };

    View.prototype.bindEvents = function($view, model) {
      var $el, els, _i, _len;

      if ($view.attributes['data-events']) {
        this.bindTo($view, $view.attributes['data-events'].value, model);
      }
      els = $view.querySelectorAll('[data-events]');
      for (_i = 0, _len = els.length; _i < _len; _i++) {
        $el = els[_i];
        this.bindTo($el, $el.attributes['data-events'].value, model);
      }
      return this;
    };

    View.prototype.bindTo = function($view, event, model) {
      ...
      for (_i = 0, _len = events.length; _i < _len; _i++) {
        ...
        $view.addEventListener(name, function(e) {
          return _this.emit('uievent', e, cb);
        });
      }
      return this;
    };
  ...
  this.Wraith.RepeatingView = (function(_super) {
    ...
    function RepeatingView($el, template) {
      var _base, _name, _ref;
      ...
      RepeatingView.__super__.constructor.call(this, this.$el, this.template);
    ...
    RepeatingView.prototype.render = function(model) {
      var $el, rendered;
    ...
    RepeatingView.prototype.removeView = function(model) {
      var $el;
    ...
    RepeatingView.prototype.updateView = function(model) {
      var $node, $view;

      if (!($node = this.$parent.querySelector('[data-id=' + model.get('_id') + ']'))) {
        return;
      }
      $view = this.render(model);
      this.$parent.replaceChild($view, $node);
      return this.bindEvents($view);
    };
  ...
  this.Wraith.Controller = (function(_super) {
    ...
    Controller.prototype.registerView = function($view) {
      ...
      view.bind('uievent', this.handleUIEvent);
    ...
    Controller.prototype.bindView = function(model, binding, view) {
      ...
      map = mapping[1];
      if (map && view instanceof Wraith.RepeatingView) {
    ...
    Controller.prototype.getModelFromEl = function($el) {
      ...
      while ($el) {
        if (modelId = (_ref = $el.parentNode.attributes['data-model']) != null ? _ref.value : void 0) {
          break;
        }
        $el = $el.parentNode;
      }
