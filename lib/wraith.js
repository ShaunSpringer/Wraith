...
(function() {
  ...
  this.Wraith.BaseView = (function(_super) {
    ...
    BaseView.prototype.bindClasses = function($view, model) {
      var $el, breakdown, els, klassMap, klasses, _i, _j, _len, _len1, _ref;
      ...
      for (_i = 0, _len = els.length; _i < _len; _i++) {
        ...
        for (_j = 0, _len1 = _ref.length; _j < _len1; _j++) {
          ...
          this.bindClass($view, model, breakdown[0], breakdown[1]);
        }
      }
      return this;
    };

    BaseView.prototype.bindClass = function($view, model, klass, binding) {
      var invert, klasses, results, _ref;
      ...
      if (results) {
        klasses = (_ref = $view.attributes['class']) != null ? _ref.value : void 0;
        return $view.setAttribute('class', klasses + ' ' + klass);
      }
    };
