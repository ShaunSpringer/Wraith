...
(function() {
  ...
  this.Wraith.View = (function(_super) {
    ...
    View.prototype.init = function() {
      var _this = this;
      return this.$el.children('[data-template]').forEach(function(item) {
  ...
  this.Wraith.Controller = (function(_super) {
    ...
    Controller.prototype.registerModel = function(name, model) {
      var i, j, l, map, mapping, model_maps, nl, view, _i, _len, _ref, _results;
      if (this.models[name]) {
        ...
        _results.push((function() {
          ...
          for (j = _j = 0, _len1 = model_maps.length; _j < _len1; j = ++_j) {
            ...
            model.bind('add:' + mapping, function(model) {
              return _this.createView(model, map);
            });
            _results1.push(model.bind('remove:' + mapping, function(model) {
              return _this.removeView(model, map);
            }));
          }
          return _results1;
        }).call(this));
    ...
    Controller.prototype.createView = function(model, map) {
    ...
    Controller.prototype.updateView = function(model, map) {
      var $view, Template, template;
      if (!($view = map.$view)) {
        return;
      }
    ...
    Controller.prototype.removeView = function(model, map) {
      var $view;
