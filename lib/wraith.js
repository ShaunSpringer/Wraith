...
(function() {
  ...
  this.Wraith.Controller = (function(_super) {
    ...
    Controller.prototype.registerModel = function(name, model) {
      var i, l, map, mapping, nl, _i, _len, _ref, _results,
        _this = this;
      if (this.models[name]) {
      ...
      for (i = _i = 0, _len = _ref.length; _i < _len; i = ++_i) {
        ...
        model.bind('add:' + mapping, function(model) {
          return _this.add(model, map);
        });
        _results.push(model.bind('remove:' + mapping, function(model) {
          return _this.remove(model, map);
        }));
      }
      return _results;
    };

    Controller.prototype.add = function(model, map) {
    ...
    Controller.prototype.remove = function(model, map) {
      var $view;
      $view = map.$view;
      return $view.remove();
    };
